...
ScrollReveal().reveal('.home_content p, .about_content, .con, p>i', {origin: 'right'});
ScrollReveal().reveal('.social_media>a, .btn, .wc', {origin: 'left'});

ScrollReveal().reveal('.box', {origin: 'down'});
